...
Not only do they provide access to gaming, music, books and more. They also allow us to access our stored value (online banking) as well as provide us with access to both the online gaming and global online shopping phenomena.
...
Whilst ubiquitous, mobile devices are not able to participate as full blockchain nodes. This is due, largely, to data storage requirements. In all blockchain protocols each individual node stores all states and processes all transactions. This provides a large amount of security, but in turn requires computational and storage resources which mobile handheld devices do not have. 
